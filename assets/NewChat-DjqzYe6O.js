...
Investing Playbooks in Minutes`;return(0,_.useLayoutEffect)(()=>{let e=o.current,t=s.current;if(!e||!t)return;let n=()=>{t.style.maxWidth=`${e.clientWidth}px`;let n=t.scrollHeight;f(n>a?a/n:1)};n();let r=new ResizeObserver(n);return r.observe(e),()=>r.disconnect()},[p,a]),(0,_.useEffect)(()=>{if(u.current===p){u.current=p;return}u.current=p,o.current,s.current,c.current,l.current},[p]),(0,D.jsxs)(`div`,{ref:o,style:{position:`relative`,width:`100%`,maxWidth:t,height:a,display:`flex`,alignItems:`center`,justifyContent:`center`,overflow:`visible`},children:[(0,D.jsx)(`style`,{children:`
      ...
      `}),(0,D.jsx)(`h1`,{ref:c,"aria-hidden":!0,style:{position:`absolute`,left:0,right:0,top:`50%`,transform:`translateY(-50%) scale(${d})`,transformOrigin:`center`,fontSize:i,lineHeight:Z,fontWeight:400,color:`var(--text-n9)`,textAlign:`center`,letterSpacing:.45,margin:0,pointerEvents:`none`,zIndex:1}}),(0,D.jsx)(`h1`,{ref:s,style:{fontSize:i,lineHeight:Z,fontWeight:400,color:`var(--text-n9)`,textAlign:`center`,letterSpacing:.45,margin:0,transform:`scale(${d})`,transformOrigin:`center`,position:`relative`,zIndex:1,whiteSpace:`pre-line`},children:p}),(0,D.jsx)(`div`,{ref:l,"aria-hidden":!0,style:{position:`absolute`,inset:0,pointerEvents:`none`,zIndex:2,overflow:`visible`}})]})}function _e({template:e,onClose:t,onSelect:n}){let r=e.tags??N(e.id);return typeof document>`u`?null:(0,te.createPortal)((0,D.jsx)(`div`,{onClick:t,style:{position:`fixed`,inset:0,background:`rgba(0,0,0,0.45)`,zIndex:9999,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:16,animation:`newchat-fade 160ms ease-out`},children:(0,D.jsxs)(`div`,{onClick:e=>e.stopPropagation(),style:{width:`100%`,maxWidth:360,background:`#ffffff`,borderRadius:14,padding:20,boxShadow:`0 20px 48px rgba(0,0,0,0.18), 0 6px 14px rgba(0,0,0,0.08)`,animation:`newchat-fadeup 220ms ease-out`},children:[(0,D.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4},children:[(0,D.jsx)(`h2`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:18,lineHeight:`24px`,fontWeight:500,color:`var(--text-n9)`,letterSpacing:.18,margin:0},children:e.label}),(0,D.jsx)(`span`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:11,lineHeight:`16px`,color:`rgba(0,0,0,0.4)`,letterSpacing:.11,fontWeight:500},children:j(e.id)})]}),(0,D.jsx)(`p`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:13,lineHeight:`20px`,color:`var(--text-n7)`,letterSpacing:.13,margin:`10px 0 0`},children:e.description}),(0,D.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:5,flexWrap:`wrap`,marginTop:10},children:r.slice(0,3).map(e=>(0,D.jsx)(`span`,{style:{height:20,padding:`0 6px`,borderRadius:5,background:`var(--b-r05)`,color:`var(--text-n5)`,fontFamily:`'Delight', sans-serif`,fontSize:11,lineHeight:`20px`,letterSpacing:.11,whiteSpace:`nowrap`},children:e},e))}),(0,D.jsx)(`div`,{style:{height:1,background:`var(--line-l07)`,margin:`20px 0 12px`}}),(0,D.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12},children:[(0,D.jsxs)(`div`,{style:{flex:1,minWidth:0,display:`flex`,alignItems:`center`,gap:10},children:[(0,D.jsx)(o,{name:e.creator,size:36}),(0,D.jsxs)(`div`,{style:{minWidth:0},children:[(0,D.jsx)(`div`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:11,lineHeight:`14px`,color:`var(--text-n5)`,letterSpacing:.11,fontWeight:500},children:`Created by`}),(0,D.jsx)(`div`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:14,lineHeight:`20px`,color:`var(--text-n9)`,letterSpacing:.14,fontWeight:500,overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`},children:e.creator})]})]}),(0,D.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:6,flexShrink:0},children:R(e.creator).map(e=>(0,D.jsx)(`a`,{href:e.href,target:`_blank`,rel:`noreferrer noopener`,"aria-label":e.label,style:{width:24,height:24,borderRadius:`9999px`,background:`var(--b-r05)`,display:`inline-flex`,alignItems:`center`,justifyContent:`center`,flexShrink:0},children:e.render()},e.key))})]}),(0,D.jsx)(`div`,{style:{height:1,background:`var(--line-l07)`,margin:`12px 0 20px`}}),(0,D.jsx)(`button`,{type:`button`,onClick:n,style:{width:`100%`,height:44,border:`none`,borderRadius:10,background:`var(--main-m1)`,color:`#fff`,fontFamily:`'Delight', sans-serif`,fontSize:14,fontWeight:500,letterSpacing:.14,cursor:`pointer`},children:`Pick this skill`})]})}),document.body)}var ve=340,Q=16;function ye({onNavigate:e}){let[t,n]=(0,_.useState)(`Popular`),[r,i]=(0,_.useState)(()=>new Set),o=(0,_.useRef)(null),[s,c]=(0,_.useState)(0);(0,_.useEffect)(()=>{if(!o.current)return;let e=o.current,t=new ResizeObserver(e=>{c(e[0]?.contentRect.width??0)});return t.observe(e),()=>t.disconnect()},[]);let l=e=>{i(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},u=(0,_.useMemo)(()=>{let e=t===`Recent`?[...m].reverse():m;return r.size===0?e:e.filter(e=>{for(let t of r)if(f(t,e))return!0;return!1})},[t,r]),p=s===0?{display:`grid`,gap:Q,width:`100%`}:{display:`grid`,gridTemplateColumns:`repeat(${Math.max(1,Math.floor((s+Q)/ve))}, minmax(0, 1fr))`,gap:Q,width:`100%`};return(0,D.jsx)(`section`,{style:{width:`100%`,padding:`40px 28px 60px`,position:`relative`,zIndex:2},children:(0,D.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16,width:`100%`},children:[(0,D.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,width:`100%`},children:[(0,D.jsx)(`p`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:20,lineHeight:`30px`,letterSpacing:.2,color:`var(--text-n9)`},children:`Trending Playbooks`}),(0,D.jsxs)(`button`,{type:`button`,onClick:()=>e(`explore`),style:{display:`inline-flex`,alignItems:`center`,gap:4,height:28,padding:`4px 0`,background:`transparent`,border:`none`,cursor:`pointer`,fontFamily:`'Delight', sans-serif`,fontSize:12,lineHeight:`20px`,letterSpacing:.12,color:`var(--text-n9)`},children:[`View all`,(0,D.jsx)(a,{name:`arrow-right-l2`,size:14,color:`var(--text-n9)`})]})]}),(0,D.jsx)(ee,{sort:t,sortOptions:g,chips:h,onSortChange:n,selectedChips:r,onChipToggle:l}),(0,D.jsx)(`div`,{ref:o,style:p,children:u.map((e,t)=>(0,D.jsx)(`div`,{style:{width:`100%`},children:(0,D.jsx)(d,{p:e,staggerMs:t%10*1e3})},e.id))})]})})}var $=960;function be({onNavigate:e}){let[t,n]=(0,_.useState)(null),[r,l]=(0,_.useState)(null),[f,m]=(0,_.useState)(null),[h,ee]=(0,_.useState)(``),[g,te]=(0,_.useState)(``),[v,y]=(0,_.useState)(null),[b,w]=(0,_.useState)(!1),[T,E]=(0,_.useState)(null);(0,_.useEffect)(()=>{if(typeof document>`u`)return;let e=!!T||b;return document.body.classList.toggle(`nc-overlay-open`,e),()=>{document.body.classList.remove(`nc-overlay-open`)}},[T,b]);let[ne,ae]=(0,_.useState)(()=>typeof window<`u`?window.innerWidth<640:!1);(0,_.useEffect)(()=>{let e=()=>ae(window.innerWidth<640);return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]);let A=(0,_.useRef)(null),j=(0,_.useRef)(null),M=(0,_.useRef)(null),N=(0,_.useRef)(null),P=(0,_.useRef)(null),[F,I]=(0,_.useState)(null),L=()=>{N.current!==null&&(window.clearTimeout(N.current),N.current=null),P.current&&=(document.removeEventListener(`mousemove`,P.current),null),I(null)},R=(e,t,n,r)=>{L(),I({x:n,y:r});let i=e=>I({x:e.clientX,y:e.clientY});document.addEventListener(`mousemove`,i),P.current=i,N.current=window.setTimeout(()=>{L(),H(e,t.getBoundingClientRect())},600)},B=()=>{M.current!==null&&(window.clearTimeout(M.current),M.current=null)},V=()=>{B(),M.current=window.setTimeout(()=>y(null),160)},H=(e,t,n=`auto`)=>{if(n===`left`){B(),y({id:e,rect:t,placeAbove:!1,side:`left`});return}let r=!1;A.current&&A.current.querySelectorAll(`button, [role="button"]`).forEach(e=>{e.getBoundingClientRect().top>t.bottom-1&&(r=!0)}),B(),y({id:e,rect:t,placeAbove:r,side:`auto`})},[ce,U]=(0,_.useState)(!1),[le,W]=(0,_.useState)(!1);(0,_.useEffect)(()=>{let e=setTimeout(()=>te(h),700);return()=>clearTimeout(e)},[h]),(0,_.useEffect)(()=>{if(!b)return;let e=e=>{e.key===`Escape`&&w(!1)};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[b]),(0,_.useEffect)(()=>{if(!t){U(!1),W(!1);return}U(!1),W(!1);let e=setTimeout(()=>U(!0),900),n=setTimeout(()=>W(!0),1500);return()=>{clearTimeout(e),clearTimeout(n)}},[t]);let G=(0,_.useMemo)(()=>re(g),[g]),K=!t&&G.length>0,q=(0,_.useMemo)(()=>t&&(x.find(e=>e.id===t)||S.find(e=>e.id===t)||C.find(e=>e.id===t))||null,[t]),J=(0,_.useMemo)(()=>q?q.recCards&&q.recCards.length?q.recCards:q.playbooks.slice(0,3).map(e=>({type:`playbook`,playbook:e})):[],[q]),Y=(0,_.useMemo)(()=>[...x,...S,...C],[]),pe=(0,_.useRef)(null),[X,Z]=(0,_.useState)(new Set);(0,_.useLayoutEffect)(()=>{let e=()=>{let e=A.current;if(!e)return;let n=Array.from(e.querySelectorAll(`button[data-skill-id]`)),r=e.querySelector(`[data-more-wrap]`);if(!r)return;n.forEach(e=>{e.style.display=``}),r.style.display=``;let i=[],a=t?2:3,o=()=>{let e=[...new Set([...n.filter(e=>e.style.display!==`none`).map(e=>e.offsetTop),r.offsetTop])].sort((e,t)=>e-t).indexOf(r.offsetTop);return e>=0&&e<=a-1},s=n.length;for(;s-- >0&&!o();){let t=n.filter(e=>e.style.display!==`none`);if(t.length===0)break;let r=t[t.length-1],a=r.dataset.skillId;a&&i.push(a),r.style.display=`none`,e.offsetWidth}i.length===0&&(r.style.display=`none`);let c=new Set(i);c.size===X.size&&[...c].every(e=>X.has(e))||Z(c)};e();let n=new ResizeObserver(e);return A.current&&n.observe(A.current),window.addEventListener(`resize`,e),()=>{n.disconnect(),window.removeEventListener(`resize`,e)}},[Y,X,t]);let me=e=>{if(ne){E(e),w(!1),y(null);return}n(t=>t===e?null:e),y(null),w(!1)},he=e=>{n(t=>t===e?null:e),y(null),w(!1)},ve=()=>{T&&(n(T),E(null),w(!1))},Q=()=>n(null),be=e=>l({text:e,seq:Date.now()}),xe=t=>{e(t===`__agent__`?`agent`:`thread/${t}`)},Se=v?x.find(e=>e.id===v.id)||S.find(e=>e.id===v.id)||C.find(e=>e.id===v.id):null;return(0,D.jsxs)(c,{activePage:`new-chat`,onNavigate:e,children:[(0,D.jsx)(`style`,{children:`
      ...
      `}),(0,D.jsxs)(`div`,{className:`h-screen overflow-y-auto relative`,style:{backgroundColor:`var(--b0-container, #ffffff)`},children:[(0,D.jsx)(`div`,{className:`flex items-center gap-[16px] h-[56px] px-[28px] shrink-0 newchat-page-topbar`,style:{position:`sticky`,top:0,zIndex:5,background:`var(--b0-container, #ffffff)`},children:(0,D.jsx)(`div`,{className:`flex-1 min-w-0`,children:(0,D.jsx)(i,{activeId:`new`,onSelect:xe,trigger:(0,D.jsxs)(`div`,{className:`flex gap-[4px] items-center min-w-0 cursor-pointer`,children:[(0,D.jsx)(`p`,{className:`font-['Delight',sans-serif] text-[14px] leading-[22px] tracking-[0.14px] text-[var(--text-n9)] truncate`,children:`New Chat`}),(0,D.jsx)(a,{name:`arrow-down-f2`,size:14,color:`var(--text-n2)`})]})})})}),(0,D.jsxs)(`section`,{className:`nc-hero-section`,style:{width:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`flex-start`,gap:36,padding:`24px 28px`,position:`relative`,zIndex:2},children:[(0,D.jsx)(ge,{selected:q,maxWidth:$}),(0,D.jsx)(`div`,{className:`nc-chatbox-wrap`,style:{width:`100%`,maxWidth:$,position:`relative`,zIndex:1},children:(0,D.jsx)(s,{shadow:!0,hideSkill:!0,hideInspector:!0,allowReferences:!1,bottomChip:q?{label:q.label,icon:q.kol?void 0:q.icon??ie,avatar:q.kol?q.creator:void 0,creator:q.creator,onRemove:Q,onHover:e=>H(q.id,e),onLeave:V}:null,injectText:r,onInputChange:ee})}),K&&(0,D.jsx)(`div`,{className:`nc-prompts-container`,style:{width:`100%`,maxWidth:$,position:`relative`,zIndex:1,marginTop:0,display:`flex`,flexDirection:`column`},children:(0,D.jsx)(`div`,{className:`nc-prompts-list`,children:G.map((e,t)=>(0,D.jsx)(se,{text:e,index:t,onClick:()=>be(e)},t))})},g),!K&&(0,D.jsxs)(`div`,{ref:A,style:{display:`flex`,flexWrap:`wrap`,gap:12,justifyContent:`center`,paddingTop:12,position:`relative`,zIndex:1,width:`100%`,maxWidth:900},children:[Y.map(e=>{let n=t===e.id;return(0,D.jsxs)(`button`,{"data-skill-id":e.id,className:`nc-pill`,onClick:()=>me(e.id),onMouseEnter:t=>{O()&&(t.currentTarget.style.boxShadow=`0 4px 12px rgba(0,0,0,0.05)`,t.currentTarget.style.transform=`translateY(-2px)`,R(e.id,t.currentTarget,t.clientX,t.clientY))},onMouseLeave:e=>{O()&&(e.currentTarget.style.boxShadow=`none`,e.currentTarget.style.transform=`translateY(0)`,L(),V())},style:{...k,background:n?`rgba(0,0,0,0.7)`:`white`,color:n?`rgba(255,255,255,0.9)`:k.color,borderColor:n?`rgba(0,0,0,0.7)`:k.border?.replace(`0.5px solid `,``)??void 0},children:[e.kol?(0,D.jsx)(o,{name:e.creator,size:22}):e.icon&&(0,D.jsx)(a,{name:e.icon,size:18,color:n?`#fff`:`var(--text-n9)`}),e.label]},e.id)}),(0,D.jsx)(`div`,{ref:j,"data-more-wrap":!0,style:{position:`relative`},children:(0,D.jsxs)(`button`,{ref:pe,type:`button`,className:`nc-pill`,"aria-expanded":b,"aria-label":`More skills`,style:{...k,cursor:`pointer`,background:b?`#f3f8f8`:`white`,border:b?`0.5px solid rgba(73,163,166,0.45)`:k.border},onMouseEnter:e=>{O()&&(e.currentTarget.style.boxShadow=`0 4px 12px rgba(0,0,0,0.05)`,e.currentTarget.style.transform=`translateY(-2px)`)},onMouseLeave:e=>{O()&&(e.currentTarget.style.boxShadow=`none`,e.currentTarget.style.transform=`translateY(0)`)},onClick:()=>{w(e=>!e),y(null)},children:[`More`,(0,D.jsx)(a,{name:`arrow-right-l2`,size:14,color:`var(--text-n5)`})]})})]}),q&&(0,D.jsx)(`div`,{className:`nc-prompts-container`,style:{width:`100%`,maxWidth:$,position:`relative`,zIndex:1,marginTop:0,display:`flex`,flexDirection:`column`},children:ce?(0,D.jsx)(`div`,{className:`nc-prompts-list`,style:{animation:`newchat-fade 280ms ease-out`},children:q.prompts.slice(0,3).map((e,t)=>(0,D.jsx)(se,{text:e,index:t,onClick:()=>be(e)},t))}):(0,D.jsxs)(`div`,{className:`nc-prompts-list nc-skeleton-anim`,style:{animation:`newchat-fade 200ms ease-out`},children:[(0,D.jsx)(z,{widthPct:92}),(0,D.jsx)(z,{widthPct:70}),(0,D.jsx)(z,{widthPct:82})]})}),q&&(0,D.jsx)(`div`,{style:{width:`100%`,maxWidth:$,position:`relative`,zIndex:2,display:`grid`,gridTemplateColumns:`repeat(${J.length||3}, minmax(0, 1fr))`,gap:16},children:le?J.map((t,n)=>{let r=t.type===`playbook`?t.playbook.id:t.push.id;return(0,D.jsx)(`div`,{onClick:()=>{if(t.type===`push`){m(t.push);return}sessionStorage.setItem(`autoOpenChatPanel`,`1`),e(`new-chat`)},style:{animation:`newchat-fadeup 360ms ease-out both`,animationDelay:`${n*50}ms`},children:t.type===`playbook`?(0,D.jsx)(d,{p:ue(t.playbook,q.id),staggerMs:n*1e3,hideTags:!0}):(0,D.jsx)(p,{a:t.push})},r)}):Array.from({length:J.length||3}).map((e,t)=>(0,D.jsx)(`div`,{className:`nc-skeleton-anim`,style:{animation:`newchat-fade 200ms ease-out`},children:(0,D.jsx)(de,{})},t))},q.id)]}),!K&&(0,D.jsx)(ye,{onNavigate:e})]}),v&&Se&&(0,D.jsx)(oe,{template:Se,anchor:v.rect,placeAbove:v.placeAbove,side:v.side,onMouseEnter:B,onMouseLeave:V}),F&&(0,D.jsxs)(`div`,{"aria-hidden":!0,style:{position:`fixed`,left:F.x+14,top:F.y+14,width:16,height:16,pointerEvents:`none`,zIndex:9999},children:[(0,D.jsxs)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 16 16`,style:{display:`block`},children:[(0,D.jsx)(`circle`,{cx:`8`,cy:`8`,r:`6`,fill:`none`,stroke:`rgba(0,0,0,0.12)`,strokeWidth:`1.6`}),(0,D.jsx)(`circle`,{cx:`8`,cy:`8`,r:`6`,fill:`none`,stroke:`var(--main-m1)`,strokeWidth:`1.6`,strokeLinecap:`round`,strokeDasharray:2*Math.PI*6,strokeDashoffset:2*Math.PI*6,transform:`rotate(-90 8 8)`,style:{animation:`nc-pill-ring-fill 600ms linear forwards`}})]}),(0,D.jsx)(`style`,{children:`
            @keyframes nc-pill-ring-fill {
              from { stroke-dashoffset: ${2*Math.PI*6}; }
              to   { stroke-dashoffset: 0; }
            }
          `})]}),b&&(0,D.jsx)(fe,{skills:Y,selectedId:t,onSelect:he,onClose:()=>w(!1)}),T&&(()=>{let e=Y.find(e=>e.id===T);return e?(0,D.jsx)(_e,{template:e,onClose:()=>E(null),onSelect:ve}):null})(),(0,D.jsx)(u,{open:!!f,onClose:()=>m(null),feedName:f?.feedName??``,description:`This automation runs on a fixed schedule and publishes new results to its subscribers. Each run pulls the latest data, applies the feed's logic, and writes a signal that powers the cards and alerts above. Open Settings → Automations to view full run logs and manage it.`})]})}export{ae as SkillPill,be as default};