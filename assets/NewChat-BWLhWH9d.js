...
Investing Playbooks in Minutes`;return(0,b.useLayoutEffect)(()=>{let e=o.current,t=s.current;if(!e||!t)return;let n=()=>{t.style.maxWidth=`${e.clientWidth}px`;let n=t.scrollHeight;f(n>a?a/n:1)};n();let r=new ResizeObserver(n);return r.observe(e),()=>r.disconnect()},[p,a]),(0,b.useEffect)(()=>{if(u.current===p){u.current=p;return}u.current=p,o.current,s.current,c.current,l.current},[p]),(0,T.jsxs)(`div`,{ref:o,style:{position:`relative`,width:`100%`,maxWidth:t,height:a,display:`flex`,alignItems:`center`,justifyContent:`center`,overflow:`visible`},children:[(0,T.jsx)(`style`,{children:`
      ...
      `}),(0,T.jsx)(`h1`,{ref:c,"aria-hidden":!0,style:{position:`absolute`,left:0,right:0,top:`50%`,transform:`translateY(-50%) scale(${d})`,transformOrigin:`center`,fontSize:i,lineHeight:K,fontWeight:400,color:`var(--text-n9)`,textAlign:`center`,letterSpacing:.45,margin:0,pointerEvents:`none`,zIndex:1}}),(0,T.jsx)(`h1`,{ref:s,style:{fontSize:i,lineHeight:K,fontWeight:400,color:`var(--text-n9)`,textAlign:`center`,letterSpacing:.45,margin:0,transform:`scale(${d})`,transformOrigin:`center`,position:`relative`,zIndex:1,whiteSpace:`pre-line`},children:p}),(0,T.jsx)(`div`,{ref:l,"aria-hidden":!0,style:{position:`absolute`,inset:0,pointerEvents:`none`,zIndex:2,overflow:`visible`}})]})}function fe({template:e,onClose:t,onSelect:n}){let r=e.tags??h(e.id);return typeof document>`u`?null:(0,re.createPortal)((0,T.jsx)(`div`,{onClick:t,style:{position:`fixed`,inset:0,background:`rgba(0,0,0,0.45)`,zIndex:9999,display:`flex`,alignItems:`center`,justifyContent:`center`,padding:16,animation:`newchat-fade 160ms ease-out`},children:(0,T.jsxs)(`div`,{onClick:e=>e.stopPropagation(),style:{width:`100%`,maxWidth:360,background:`#ffffff`,borderRadius:14,padding:20,boxShadow:`0 20px 48px rgba(0,0,0,0.18), 0 6px 14px rgba(0,0,0,0.08)`,animation:`newchat-fadeup 220ms ease-out`},children:[(0,T.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:4},children:[(0,T.jsx)(`h2`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:18,lineHeight:`24px`,fontWeight:500,color:`var(--text-n9)`,letterSpacing:.18,margin:0},children:e.label}),(0,T.jsx)(`span`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:11,lineHeight:`16px`,color:`rgba(0,0,0,0.4)`,letterSpacing:.11,fontWeight:500},children:j(e.id)})]}),(0,T.jsx)(`p`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:13,lineHeight:`20px`,color:`var(--text-n7)`,letterSpacing:.13,margin:`10px 0 0`},children:e.description}),(0,T.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:5,flexWrap:`wrap`,marginTop:10},children:r.slice(0,3).map(e=>(0,T.jsx)(`span`,{style:{height:20,padding:`0 6px`,borderRadius:5,background:`var(--b-r05)`,color:`var(--text-n5)`,fontFamily:`'Delight', sans-serif`,fontSize:11,lineHeight:`20px`,letterSpacing:.11,whiteSpace:`nowrap`},children:e},e))}),(0,T.jsx)(`div`,{style:{height:1,background:`var(--line-l07)`,margin:`20px 0 12px`}}),(0,T.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12},children:[(0,T.jsxs)(`div`,{style:{flex:1,minWidth:0,display:`flex`,alignItems:`center`,gap:10},children:[(0,T.jsx)(a,{name:e.creator,size:36}),(0,T.jsxs)(`div`,{style:{minWidth:0},children:[(0,T.jsx)(`div`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:11,lineHeight:`14px`,color:`var(--text-n5)`,letterSpacing:.11,fontWeight:500},children:`Created by`}),(0,T.jsx)(`div`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:14,lineHeight:`20px`,color:`var(--text-n9)`,letterSpacing:.14,fontWeight:500,overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`},children:e.creator})]})]}),(0,T.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:6,flexShrink:0},children:p(e.creator).map(e=>(0,T.jsx)(`a`,{href:e.href,target:`_blank`,rel:`noreferrer noopener`,"aria-label":e.label,style:{width:24,height:24,borderRadius:`9999px`,background:`var(--b-r05)`,display:`inline-flex`,alignItems:`center`,justifyContent:`center`,flexShrink:0},children:e.render()},e.key))})]}),(0,T.jsx)(`div`,{style:{height:1,background:`var(--line-l07)`,margin:`12px 0 20px`}}),(0,T.jsx)(`button`,{type:`button`,onClick:n,style:{width:`100%`,height:44,border:`none`,borderRadius:10,background:`var(--main-m1)`,color:`#fff`,fontFamily:`'Delight', sans-serif`,fontSize:14,fontWeight:500,letterSpacing:.14,cursor:`pointer`},children:`Pick this skill`})]})}),document.body)}var Y=340,X=16;function pe({onNavigate:e}){let[t,n]=(0,b.useState)(`Popular`),[r,a]=(0,b.useState)(()=>new Set),o=(0,b.useRef)(null),[s,c]=(0,b.useState)(0);(0,b.useEffect)(()=>{if(!o.current)return;let e=o.current,t=new ResizeObserver(e=>{c(e[0]?.contentRect.width??0)});return t.observe(e),()=>t.disconnect()},[]);let l=e=>{a(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},u=(0,b.useMemo)(()=>{let e=t===`Recent`?[...O].reverse():O;return r.size===0?e:e.filter(e=>{for(let t of r)if(k(t,e))return!0;return!1})},[t,r]),d=s===0?{display:`grid`,gap:X,width:`100%`}:{display:`grid`,gridTemplateColumns:`repeat(${Math.max(1,Math.floor((s+X)/Y))}, minmax(0, 1fr))`,gap:X,width:`100%`};return(0,T.jsx)(`section`,{style:{width:`100%`,padding:`40px 28px 60px`,position:`relative`,zIndex:2},children:(0,T.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16,width:`100%`},children:[(0,T.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,width:`100%`},children:[(0,T.jsx)(`p`,{style:{fontFamily:`'Delight', sans-serif`,fontSize:20,lineHeight:`30px`,letterSpacing:.2,color:`var(--text-n9)`},children:`Trending Playbooks`}),(0,T.jsxs)(`button`,{type:`button`,onClick:()=>e(`explore`),style:{display:`inline-flex`,alignItems:`center`,gap:4,height:28,padding:`4px 0`,background:`transparent`,border:`none`,cursor:`pointer`,fontFamily:`'Delight', sans-serif`,fontSize:12,lineHeight:`20px`,letterSpacing:.12,color:`var(--text-n9)`},children:[`View all`,(0,T.jsx)(i,{name:`arrow-right-l2`,size:14,color:`var(--text-n9)`})]})]}),(0,T.jsx)(v,{sort:t,sortOptions:y,chips:_,onSortChange:n,selectedChips:r,onChipToggle:l}),(0,T.jsx)(`div`,{ref:o,style:d,children:u.map((e,t)=>(0,T.jsx)(`div`,{style:{width:`100%`},children:(0,T.jsx)(ne,{p:e,staggerMs:t%10*1e3})},e.id))})]})})}var Z=960;function Q({onNavigate:e}){let[t,n]=(0,b.useState)(null),[r,u]=(0,b.useState)(null),[p,h]=(0,b.useState)(null),[_,v]=(0,b.useState)(``),[y,re]=(0,b.useState)(``),[x,S]=(0,b.useState)(null),[C,w]=(0,b.useState)(!1),[E,D]=(0,b.useState)(null);(0,b.useEffect)(()=>{if(typeof document>`u`)return;let e=!!E||C;return document.body.classList.toggle(`nc-overlay-open`,e),()=>{document.body.classList.remove(`nc-overlay-open`)}},[E,C]);let[O,k]=(0,b.useState)(()=>typeof window<`u`?window.innerWidth<640:!1);(0,b.useEffect)(()=>{let e=()=>k(window.innerWidth<640);return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]);let j=(0,b.useRef)(null),ce=(0,b.useRef)(null),N=(0,b.useRef)(null),P=(0,b.useRef)(null),F=(0,b.useRef)(null),[I,L]=(0,b.useState)(null),R=()=>{P.current!==null&&(window.clearTimeout(P.current),P.current=null),F.current&&=(document.removeEventListener(`mousemove`,F.current),null),L(null)},z=(e,t,n,r)=>{R(),L({x:n,y:r});let i=e=>L({x:e.clientX,y:e.clientY});document.addEventListener(`mousemove`,i),F.current=i,P.current=window.setTimeout(()=>{R(),H(e,t.getBoundingClientRect())},600)},B=()=>{N.current!==null&&(window.clearTimeout(N.current),N.current=null)},V=()=>{B(),N.current=window.setTimeout(()=>S(null),160)},H=(e,t,n=`auto`)=>{if(n===`left`){B(),S({id:e,rect:t,placeAbove:!1,side:`left`});return}let r=!1;j.current&&j.current.querySelectorAll(`button, [role="button"]`).forEach(e=>{e.getBoundingClientRect().top>t.bottom-1&&(r=!0)}),B(),S({id:e,rect:t,placeAbove:r,side:`auto`})},[U,W]=(0,b.useState)(!1),[G,K]=(0,b.useState)(!1);(0,b.useEffect)(()=>{let e=setTimeout(()=>re(_),700);return()=>clearTimeout(e)},[_]),(0,b.useEffect)(()=>{if(!C)return;let e=e=>{e.key===`Escape`&&w(!1)};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[C]),(0,b.useEffect)(()=>{if(!t){W(!1),K(!1);return}W(!1),K(!1);let e=setTimeout(()=>W(!0),900),n=setTimeout(()=>K(!0),1500);return()=>{clearTimeout(e),clearTimeout(n)}},[t]);let q=(0,b.useMemo)(()=>ie(y),[y]),J=!t&&q.length>0,Y=(0,b.useMemo)(()=>t&&(m.find(e=>e.id===t)||f.find(e=>e.id===t)||g.find(e=>e.id===t))||null,[t]),X=(0,b.useMemo)(()=>Y?Y.recCards&&Y.recCards.length?Y.recCards:Y.playbooks.slice(0,3).map(e=>({type:`playbook`,playbook:e})):[],[Y]),Q=(0,b.useMemo)(()=>[...m,...f,...g],[]),me=(0,b.useRef)(null),[$,he]=(0,b.useState)(new Set);(0,b.useLayoutEffect)(()=>{let e=()=>{let e=j.current;if(!e)return;let t=Array.from(e.querySelectorAll(`button[data-skill-id]`)),n=e.querySelector(`[data-more-wrap]`);if(!n)return;t.forEach(e=>{e.style.display=``}),n.style.display=``;let r=[],i=()=>{let e=[...new Set([...t.filter(e=>e.style.display!==`none`).map(e=>e.offsetTop),n.offsetTop])].sort((e,t)=>e-t).indexOf(n.offsetTop);return e>=0&&e<=1},a=t.length;for(;a-- >0&&!i();){let n=t.filter(e=>e.style.display!==`none`);if(n.length===0)break;let i=n[n.length-1],a=i.dataset.skillId;a&&r.push(a),i.style.display=`none`,e.offsetWidth}r.length===0&&(n.style.display=`none`);let o=new Set(r);o.size===$.size&&[...o].every(e=>$.has(e))||he(o)};e();let t=new ResizeObserver(e);return j.current&&t.observe(j.current),window.addEventListener(`resize`,e),()=>{t.disconnect(),window.removeEventListener(`resize`,e)}},[Q,$,t]);let ge=e=>{if(O){D(e),w(!1),S(null);return}n(t=>t===e?null:e),S(null),w(!1)},_e=e=>{n(t=>t===e?null:e),S(null),w(!1)},ve=()=>{E&&(n(E),D(null),w(!1))},ye=()=>n(null),be=e=>u({text:e,seq:Date.now()}),xe=t=>{e(t===`__agent__`?`agent`:`thread/${t}`)},Se=x?m.find(e=>e.id===x.id)||f.find(e=>e.id===x.id)||g.find(e=>e.id===x.id):null;return(0,T.jsxs)(c,{activePage:`new-chat`,onNavigate:e,children:[(0,T.jsx)(`style`,{children:`
      ...
      `}),(0,T.jsxs)(`div`,{className:`h-screen overflow-y-auto relative`,style:{backgroundColor:`var(--b0-container, #ffffff)`},children:[(0,T.jsx)(`div`,{className:`flex items-center gap-[16px] h-[56px] px-[28px] shrink-0 newchat-page-topbar`,style:{position:`sticky`,top:0,zIndex:5,background:`var(--b0-container, #ffffff)`},children:(0,T.jsx)(`div`,{className:`flex-1 min-w-0`,children:(0,T.jsx)(s,{activeId:`new`,onSelect:xe,trigger:(0,T.jsxs)(`div`,{className:`flex gap-[4px] items-center min-w-0 cursor-pointer`,children:[(0,T.jsx)(`p`,{className:`font-['Delight',sans-serif] text-[14px] leading-[22px] tracking-[0.14px] text-[var(--text-n9)] truncate`,children:`New Chat`}),(0,T.jsx)(i,{name:`arrow-down-f2`,size:14,color:`var(--text-n2)`})]})})})}),(0,T.jsxs)(`section`,{className:`nc-hero-section`,style:{width:`100%`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`flex-start`,gap:36,padding:`24px 28px`,position:`relative`,zIndex:2},children:[(0,T.jsx)(de,{selected:Y,maxWidth:Z}),(0,T.jsx)(`div`,{className:`nc-chatbox-wrap`,style:{width:`100%`,maxWidth:Z,position:`relative`,zIndex:1},children:(0,T.jsx)(o,{shadow:!0,hideSkill:!0,hideInspector:!0,allowReferences:!1,bottomChip:Y?{label:Y.label,icon:Y.kol?void 0:Y.icon??ae,avatar:Y.kol?Y.creator:void 0,creator:Y.creator,onRemove:ye,onHover:e=>H(Y.id,e),onLeave:V}:null,injectText:r,onInputChange:v})}),J&&(0,T.jsx)(`div`,{className:`nc-prompts-container`,style:{width:`100%`,maxWidth:Z,position:`relative`,zIndex:1,marginTop:0,display:`flex`,flexDirection:`column`},children:(0,T.jsx)(`div`,{className:`nc-prompts-list`,children:q.map((e,t)=>(0,T.jsx)(se,{text:e,index:t,onClick:()=>be(e)},t))})},y),!J&&(0,T.jsxs)(`div`,{ref:j,style:{display:`flex`,flexWrap:`wrap`,gap:12,justifyContent:`center`,paddingTop:12,position:`relative`,zIndex:1,width:`100%`,maxWidth:900},children:[Q.map(e=>{let n=t===e.id;return(0,T.jsx)(l,{"data-skill-id":e.id,className:`nc-pill`,label:e.label,active:n,icon:e.kol?void 0:e.icon,avatar:e.kol?e.avatarSrc?(0,T.jsx)(`img`,{src:`/alva-infant/avatars/${e.avatarSrc}`,alt:``,className:`size-[22px] shrink-0 rounded-full object-cover`}):(0,T.jsx)(a,{name:e.creator,size:22}):void 0,onClick:()=>ge(e.id),onMouseEnter:t=>{A()&&(t.currentTarget.style.boxShadow=`0 4px 12px rgba(0,0,0,0.05)`,t.currentTarget.style.transform=`translateY(-2px)`,z(e.id,t.currentTarget,t.clientX,t.clientY))},onMouseLeave:e=>{A()&&(e.currentTarget.style.boxShadow=`none`,e.currentTarget.style.transform=`translateY(0)`,R(),V())}},e.id)}),(0,T.jsx)(`div`,{ref:ce,"data-more-wrap":!0,style:{position:`relative`},children:(0,T.jsx)(l,{ref:me,className:`nc-pill`,"aria-expanded":C,"aria-label":`More skills`,label:`More`,trailing:(0,T.jsx)(i,{name:`arrow-right-l2`,size:14,color:`var(--text-n5)`}),style:C?{background:`#f3f8f8`,border:`0.5px solid rgba(73,163,166,0.45)`}:void 0,onMouseEnter:e=>{A()&&(e.currentTarget.style.boxShadow=`0 4px 12px rgba(0,0,0,0.05)`,e.currentTarget.style.transform=`translateY(-2px)`)},onMouseLeave:e=>{A()&&(e.currentTarget.style.boxShadow=`none`,e.currentTarget.style.transform=`translateY(0)`)},onClick:()=>{w(e=>!e),S(null)}})})]}),Y&&(0,T.jsx)(`div`,{className:`nc-prompts-container`,style:{width:`100%`,maxWidth:Z,position:`relative`,zIndex:1,marginTop:0,display:`flex`,flexDirection:`column`},children:U?(0,T.jsx)(`div`,{className:`nc-prompts-list`,style:{animation:`newchat-fade 280ms ease-out`},children:Y.prompts.slice(0,3).map((e,t)=>(0,T.jsx)(se,{text:e,index:t,onClick:()=>be(e)},t))}):(0,T.jsxs)(`div`,{className:`nc-prompts-list nc-skeleton-anim`,style:{animation:`newchat-fade 200ms ease-out`},children:[(0,T.jsx)(M,{widthPct:92}),(0,T.jsx)(M,{widthPct:70}),(0,T.jsx)(M,{widthPct:82})]})}),Y&&(0,T.jsx)(`div`,{style:{width:`100%`,maxWidth:Z,position:`relative`,zIndex:2,display:`flex`,flexDirection:`column`,gap:16},children:G?(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(3, minmax(0, 1fr))`,gap:16},children:X.flatMap(e=>e.type===`playbook`?[e.playbook]:[]).slice(0,3).map((t,n)=>(0,T.jsx)(`div`,{onClick:()=>{sessionStorage.setItem(`autoOpenChatPanel`,`1`),e(`new-chat`)},style:{animation:`newchat-fadeup 360ms ease-out both`,animationDelay:`${n*50}ms`},children:(0,T.jsx)(ne,{p:le(t,Y.id),staggerMs:n*1e3})},t.id))}),(()=>{let e=X.flatMap(e=>e.type===`push`?[e.push]:[]).slice(0,2);return e.length===0?null:(0,T.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(${e.length}, minmax(0, 1fr))`,gap:16,gridAutoRows:281.5},children:e.map((e,t)=>(0,T.jsx)(`div`,{onClick:()=>h(e),style:{height:`100%`,cursor:`pointer`,animation:`newchat-fadeup 360ms ease-out both`,animationDelay:`${(t+3)*50}ms`},children:(0,T.jsx)(ee,{a:e})},e.id))})})()]}):(0,T.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(3, minmax(0, 1fr))`,gap:16},children:Array.from({length:3}).map((e,t)=>(0,T.jsx)(`div`,{className:`nc-skeleton-anim`,style:{animation:`newchat-fade 200ms ease-out`},children:(0,T.jsx)(ue,{})},t))})},Y.id)]}),!J&&(0,T.jsx)(pe,{onNavigate:e})]}),x&&Se&&(0,T.jsx)(oe,{template:Se,anchor:x.rect,placeAbove:x.placeAbove,side:x.side,onMouseEnter:B,onMouseLeave:V}),I&&(0,T.jsxs)(`div`,{"aria-hidden":!0,style:{position:`fixed`,left:I.x+14,top:I.y+14,width:16,height:16,pointerEvents:`none`,zIndex:9999},children:[(0,T.jsxs)(`svg`,{width:`16`,height:`16`,viewBox:`0 0 16 16`,style:{display:`block`},children:[(0,T.jsx)(`circle`,{cx:`8`,cy:`8`,r:`6`,fill:`none`,stroke:`rgba(0,0,0,0.12)`,strokeWidth:`1.6`}),(0,T.jsx)(`circle`,{cx:`8`,cy:`8`,r:`6`,fill:`none`,stroke:`var(--main-m1)`,strokeWidth:`1.6`,strokeLinecap:`round`,strokeDasharray:2*Math.PI*6,strokeDashoffset:2*Math.PI*6,transform:`rotate(-90 8 8)`,style:{animation:`nc-pill-ring-fill 600ms linear forwards`}})]}),(0,T.jsx)(`style`,{children:`
            @keyframes nc-pill-ring-fill {
              from { stroke-dashoffset: ${2*Math.PI*6}; }
              to   { stroke-dashoffset: 0; }
            }
          `})]}),C&&(0,T.jsx)(d,{skills:Q,selectedId:t,onSelect:_e,onClose:()=>w(!1)}),E&&(()=>{let e=Q.find(e=>e.id===E);return e?(0,T.jsx)(fe,{template:e,onClose:()=>D(null),onSelect:ve}):null})(),(0,T.jsx)(te,{open:!!p,onClose:()=>h(null),feedName:p?.feedName??``,alerts:p?[p]:void 0,description:`This automation runs on a fixed schedule and publishes new results to its subscribers. Each run pulls the latest data, applies the feed's logic, and writes a signal that powers the cards and alerts above. Open Settings → Automations to view full run logs and manage it.`})]})}export{Q as default};