...
function AutoRefillModal({ onClose, onConfirm }: { onClose: () => void; onConfirm: (t: string, u: string) => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.5)' }} onClick={onClose}>
      <div className="w-[440px] rounded-[12px] flex flex-col" style={{ background: '#fff', boxShadow: 'var(--shadow-l)' }} onClick={(e) => e.stopPropagation()}>
        <div className="px-[24px] pt-[24px] pb-[16px] flex items-center justify-between">
          <span className="text-[18px] leading-[28px] tracking-[0.18px]" style={{ color: 'var(--text-n9)', fontFamily: FONT }}>Turn on auto-refill?</span>
        ...
        <div className="px-[24px] pt-[20px] pb-[24px] flex flex-col gap-[20px]">
          ...
          {([
            ...
            <div key={f.label} className="flex flex-col gap-[6px]">
              <span className="text-[12px] leading-[18px] tracking-[0.12px] font-medium" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>{f.label}</span>
              <div className="relative">
                ...
                <input type="number" min="1" value={f.value} onChange={(e) => f.set(e.target.value)}
                  ...
                  style={{ color: 'var(--text-n9)', border: '1px solid var(--line-l12)', background: 'transparent', fontFamily: FONT }}
                />
              </div>
              {Number(f.value) > 0 && (
                <span className="text-[12px] leading-[18px]" style={{ color: 'var(--text-n3)', fontFamily: FONT }}>
...
function AddCreditsModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.5)' }} onClick={onClose}>
      <div className="w-[440px] rounded-[12px] flex flex-col" style={{ background: '#fff', boxShadow: 'var(--shadow-l)' }} onClick={(e) => e.stopPropagation()}>
        <div className="px-[24px] pt-[24px] pb-[16px] flex items-center justify-between">
          <span className="text-[18px] leading-[28px]" style={{ color: 'var(--text-n9)', fontFamily: FONT }}>Add Credits</span>
          <button className="w-[28px] h-[28px] flex items-center justify-center rounded-[4px] cursor-pointer hover:bg-[rgba(0,0,0,0.05)]" style={{ border: 'none', background: 'none' }} onClick={onClose}>
            <span className="text-[18px] leading-none" style={{ color: 'var(--text-n5)' }}>&times;</span>
          </button>
        </div>
        ...
        {step === 'select' && (
          <div className="px-[24px] pt-[20px] pb-[24px] flex flex-col gap-[20px]">
            <div className="flex flex-col gap-[8px]">
              <span className="text-[12px] leading-[18px] font-medium" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>Select amount</span>
                ...
                {PRESETS.map((p) => (
                  <button key={p}
                    ...
                    style={{
                      ...
                      background: selected === p ? 'var(--main-m1)' : 'transparent',
                      border: selected === p ? '1px solid var(--main-m1)' : '1px solid var(--line-l12)',
                      fontFamily: FONT,
                    }}
            ...
            <div className="flex flex-col gap-[8px]">
              <span className="text-[12px] leading-[18px] font-medium" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>Or enter custom amount</span>
              <div className="relative">
                ...
                <input type="number" min="1" placeholder="Enter amount" value={custom}
                  ...
                  style={{ color: 'var(--text-n9)', border: isCustom ? '1px solid var(--main-m1)' : '1px solid var(--line-l12)', background: 'transparent', fontFamily: FONT }}
                />
              </div>
            </div>
            <div className="flex items-center justify-between px-[16px] py-[12px] rounded-[8px]" style={{ background: 'rgba(73,163,166,0.06)' }}>
              <span className="text-[14px]" style={{ color: 'var(--text-n7)', fontFamily: FONT }}>You'll receive</span>
              <span className="text-[16px] font-medium" style={{ color: valid ? 'var(--main-m1)' : 'var(--text-n3)', fontFamily: FONT }}>
        ...
        {step === 'processing' && (
          <div className="px-[24px] py-[48px] flex flex-col items-center gap-[16px]">
            <div className="w-[32px] h-[32px] rounded-full border-[3px] border-[var(--line-l07)] animate-spin" style={{ borderTopColor: 'var(--main-m1)' }} />
            <span className="text-[14px]" style={{ color: 'var(--text-n7)', fontFamily: FONT }}>Processing payment...</span>
          </div>
        )}
        {step === 'success' && (
          <div className="px-[24px] py-[40px] flex flex-col items-center gap-[16px]">
            ...
            <button className="h-[40px] px-[24px] rounded-[8px] text-[14px] font-medium cursor-pointer mt-[4px]" style={{ color: '#fff', background: 'var(--main-m1)', border: 'none', fontFamily: FONT }} onClick={onClose}>Done</button>
          </div>
        )}
      </div>
    </div>
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        style={{ color: 'var(--text-n9)', background: 'transparent', border: '0.5px solid var(--line-l3)', fontFamily: FONT }}
        onClick={() => setOpen(!open)}
      >
        <CdnIcon name="settings-l" size={14} color="var(--text-n9)" />
        Manage
      </button>
      {open && (
        <div className="absolute right-0 top-[36px] z-10 min-w-[180px] rounded-[6px] py-[8px]" style={{ background: '#fff', boxShadow: 'var(--shadow-s)', border: '0.5px solid var(--line-l2)' }}>
          <button className="w-full text-left px-[16px] py-[7px] text-[14px] leading-[22px] cursor-pointer hover:bg-[rgba(0,0,0,0.03)]" style={{ color: 'var(--text-n9)', border: 'none', background: 'none', fontFamily: FONT }} onClick={() => { setOpen(false); onNavigate('pricing'); }}>Change Plan</button>
          <button className="w-full text-left px-[16px] py-[7px] text-[14px] leading-[22px] cursor-pointer hover:bg-[rgba(0,0,0,0.03)]" style={{ color: 'var(--main-m4)', border: 'none', background: 'none', fontFamily: FONT }} onClick={() => setOpen(false)}>Cancel Subscription</button>
        </div>
      )}
    </div>
  );
  ...
  return (
    <SettingsLayout active="billing" onNavigate={onNavigate}>
      ...
      <div className="flex items-center justify-between w-full">
        <h1 className="text-[28px] leading-[38px] tracking-[0.28px]" style={{ color: 'var(--text-n9)', fontFamily: FONT, fontWeight: 400 }}>Usage</h1>
        <button
          className="h-[28px] px-[12px] rounded-[6px] text-[12px] font-medium leading-[20px] tracking-[0.12px] cursor-pointer"
          style={{ color: 'var(--text-n9)', border: '0.5px solid var(--line-l3)', background: 'transparent', fontFamily: FONT }}
      ...
      {/* Plan card */}
      <div className="rounded-[12px] flex flex-col gap-[16px] pt-[24px] pb-[16px] px-[24px]" style={{ background: 'rgba(255,255,255,0.7)', border: '0.5px solid var(--line-l2)' }}>

        {/* Top row */}
        <div className="flex items-center gap-[12px]">
          <div className="flex-1 flex items-center gap-[8px]">
            <span className="text-[18px] leading-[28px] tracking-[0.18px]" style={{ color: 'var(--text-n9)', fontFamily: FONT }}>{PLAN.name}</span>
            <span className="text-[12px] leading-[20px] tracking-[0.12px] px-[6px] rounded-[4px]" style={{ color: 'var(--main-m1)', background: 'var(--main-m1-10)', fontFamily: FONT }}>Annually</span>
          </div>
          <button
        ...
        <div className="flex gap-[24px] text-[14px] leading-[22px]" style={{ fontFamily: FONT }}>
          <div className="flex gap-[8px]">
            <span style={{ color: 'var(--text-n5)' }}>Start Date</span>
            <span style={{ color: 'var(--text-n7)' }}>{PLAN.startDate}</span>
          </div>
          <div className="flex gap-[8px]">
            <span style={{ color: 'var(--text-n5)' }}>Next Billing</span>
            <span style={{ color: 'var(--text-n7)' }}>{PLAN.nextBilling}</span>
          </div>
        </div>

        <div className="h-px w-full" style={{ background: 'var(--b-r07)' }} />
          ...
          <div className="flex items-end gap-[8px] h-[64px]">
            <div className="flex flex-col">
              ...
              <div className="flex items-end gap-[8px]">
                <span className="text-[32px] leading-[42px] tracking-[0.32px]" style={{ color: 'var(--text-n9)', fontFamily: FONT, fontWeight: 400 }}>
                  {TOTAL_AVAILABLE.toLocaleString()}
                </span>
                <span className="text-[12px] leading-[20px] py-[7px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>Credits</span>
              </div>
            </div>
            <div className="flex-1 flex items-center justify-end py-[7px]">
              <span className="text-[12px] leading-[20px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>
                300 expire tomorrow, 2,400 in 3 days  •  10% Used
              </span>
            </div>
          </div>
          <div className="w-full h-[6px] rounded-full flex overflow-hidden" style={{ background: 'var(--b-r07)' }}>
            {tiers.map(t => (
                ...
                <div className="flex items-end justify-between">
                  <div className="flex flex-col gap-[4px]">
                    ...
                    <div className="flex items-end gap-[4px]">
                      <span className="text-[20px] leading-[30px]" style={{ color: 'var(--text-n9)', fontFamily: FONT, fontWeight: 400 }}>{remaining.toLocaleString()}</span>
                      <span className="text-[14px] leading-[22px] py-[3px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>/ {t.total.toLocaleString()}</span>
                    </div>
                  </div>
                  <span className="text-[10px] leading-[16px] pb-[6px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>{t.expires}</span>
                </div>
                <div className="h-[6px] rounded-[3px] overflow-hidden" style={{ background: 'var(--b-r07)' }}>
        ...
        <div className="flex items-center gap-[8px] px-[16px] py-[12px] rounded-[6px]" style={{ background: 'rgba(230,169,26,0.1)' }}>
          ...
          <span className="flex-1 text-[14px] leading-[22px]" style={{ color: 'var(--text-n9)', fontFamily: FONT }}>
            Your subscription will expire on Jan 8, 2027 and you will be downgraded to Free afterward.
          </span>
          <CdnIcon name="arrow-right-l1" size={14} color="var(--text-n5)" />
        </div>
        ...
        <div className="flex items-center gap-[16px]">
          ...
          >
            <span className="text-[14px] leading-[22px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>{autoRefill ? 'On' : 'Off'}</span>
      ...
      {/* Credits History */}
      <div className="rounded-[12px] overflow-hidden flex flex-col" style={{ background: '#fff', border: '0.5px solid var(--line-l2)' }}>
        <div className="flex items-center px-[24px] py-[16px]">
          <span className="flex-1 text-[16px] leading-[26px]" style={{ color: 'var(--text-n9)', fontFamily: FONT }}>Credits History</span>
        </div>
        <div className="flex items-center gap-[20px] px-[24px] py-[12px]" style={{ background: 'var(--b-r02)' }}>
          <span className="flex-1 text-[12px] leading-[20px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>Detail</span>
          <span className="w-[100px] text-right text-[12px] leading-[20px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>Date</span>
          <span className="w-[100px] text-right text-[12px] leading-[20px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>Credits Usage</span>
        </div>
        {HISTORY.map((h, i) => (
          <div key={i} className="flex items-center gap-[20px] px-[24px] py-[16px]" style={{ background: i % 2 === 1 ? 'var(--b-r02)' : 'transparent' }}>
            <div className="flex-1 min-w-0 flex items-center gap-[4px]">
              <CdnIcon name={h.icon === 'thread' ? 'sidebar-thread-normal' : 'sidebar-dashboard-normal'} size={20} color="var(--text-n7)" />
              <span className="truncate text-[14px] leading-[22px]" style={{ color: 'var(--text-n9)', fontFamily: FONT }}>{h.detail}</span>
            </div>
            <span className="w-[100px] text-right text-[14px] leading-[22px]" style={{ color: 'var(--text-n5)', fontFamily: FONT }}>{h.date}</span>
            <span className="w-[100px] text-right text-[14px] leading-[22px] font-medium" style={{ color: h.credits > 0 ? 'var(--main-m1)' : 'var(--text-n9)', fontFamily: FONT }}>
