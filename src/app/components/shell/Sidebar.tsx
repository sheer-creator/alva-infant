...
export function Sidebar({ activePage, onNavigate, chatOpen, onChatToggle, activeConversationId, onSelectConversation }: SidebarProps) {
  return (
    ...
    >
      {/* Logo */}
      <div className="h-[48px] flex items-center px-[8px] py-[16px] shrink-0">
      ...
      <div className="rounded-[4px] p-[8px] flex items-center gap-[8px] shrink-0 mt-auto">
        <div className="w-[24px] h-[24px] rounded-full bg-[#49A3A6] flex items-center justify-center text-[11px] font-medium text-white shrink-0">
          A
        </div>
        <span className="text-[13px] text-white tracking-[0.13px]">Alva Intern</span>
      </div>
    </aside>
  );
}
